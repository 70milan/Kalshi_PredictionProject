...
def get(path: str, params: dict = None) -> dict:
    """Generic authenticated GET with error handling."""
    try:
...
def fetch_markets_for_series(series_ticker: str, status: str) -> list[dict]:
    """
...
def fetch_all_historical(series_tickers: list[str]) -> tuple[list[dict], list[dict]]:
    """
...
def save_to_bronze(markets: list[dict], output_dir: str, status: str) -> str:
    """
...
def preview(markets: list[dict], status: str, n: int = 5):
