...
// turbo
1. Read `.claude/skills/project-goal-validator/SKILL.md` — project goals, no hardcoding, security, git protocol
2. Read `.claude/skills/brainstorm/SKILL.md` — creative/constructive work process
3. Read `.claude/skills/debugger/SKILL.md` — error handling and debugging
4. Read `.claude/skills/kalshi-api-debug/SKILL.md` — Kalshi API patterns and gotchas
5. Read `.claude/skills/data_engineer_pipeline_expert/SKILL.md` — data pipeline best practices
6. Read `.claude/skills/state-audit/SKILL.md` — project state and audit format
...
- Bug fix / Error
  → Read .claude/skills/debugger/SKILL.md first, then proceed

- Kalshi-related
  → Read .claude/skills/kalshi-api-debug/SKILL.md first, then proceed

- State audit / context sync / project checkpoint
  → Read .claude/skills/state-audit/SKILL.md and follow it completely
...
// turbo
Read .claude/skills/brainstorm/SKILL.md and follow its process completely:
...
// turbo
Read .claude/skills/project-goal-validator/SKILL.md and confirm:
...
Read .claude/skills/data_engineer_pipeline_expert/SKILL.md
